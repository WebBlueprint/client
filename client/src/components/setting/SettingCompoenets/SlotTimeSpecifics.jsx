        ...
        <Container>
          {daysOfWeek.map((day) => (
            <Btn
              ...
              style={{ backgroundColor: formData.selectedDays.includes(day) ? "green" : "" }}
            >
              {day}
            </Btn>
          ))}
      ...
      <div>
        ...
        <BigWrap>
          <div>
            ...
            <select value={formData.lessonTime} onChange={handleLessonTimeChange}>
          ...
          <div>
            ...
            <select value={formData.breakTime} onChange={handleBreakTimeChange}>
          ...
          <Container>
            {availableTimes.map((time, index) => (
              <Btn
                ...
                style={{
                  backgroundColor: formData.reservedTimes.includes(time) ? "green" : ""
                }}
              >
                {time}
              </Btn>
